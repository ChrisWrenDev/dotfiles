...
The URL pattern depends on how your thoughts repository is set up:

- If thoughts/ is a separate repo: `https://github.com/YOUR_ORG/thoughts/blob/main/...`
- If thoughts/ is in the main repo: `https://github.com/YOUR_ORG/YOUR_REPO/blob/main/thoughts/...`

Configure the base URL for your thoughts repository in your project's AGENTS.md or opencode config.
...
- **wui**: For tickets about the repo's frontend/WUI directory
